...
export function HomeTab({ firstName, kids, events, pendingTasks, reminders, setupChecklist, setupSummary, memberOptions, assigneeOptions, onAddEvent, onAddTask, onToggleTask, onDeleteTask, onDeleteEvent, onDismissReminder, onSnoozeReminder, saving, onNavigate, coparentingSchedule, coparentingOverrides = [], readOnly = false }: Props) {
      ...
      {setupChecklist.length > 0 && (
        <div style={{ marginBottom: "1.5rem", borderRadius: "16px", background: "linear-gradient(135deg,rgba(99,102,241,0.1),rgba(139,92,246,0.08))", border: "1px solid rgba(99,102,241,0.2)", padding: "1rem 1.25rem", display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <p style={{ fontSize: "0.75rem", color: "var(--muted)", lineHeight: 1.5 }}>Finish Manage Family to {setupSummary} before Famco syncs your inbox automatically. Doing this first gives you better matches for school, activity, household, and billing emails.</p>
          </div>
