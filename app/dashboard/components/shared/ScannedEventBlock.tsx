...
import { getScannedEventMemberName } from "../../lib/scanned-event-members"
  ...
  return (
    <div onClick={() => setExpanded((v) => !v)} style={{ cursor: "pointer", padding: "0.625rem 0.875rem", background: `${color}10`, borderRadius: "10px", border: `1px solid ${color}33`, borderLeft: `3px solid ${color}` }}>
      <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
        ...
        {memberName && (
          <span style={{ fontSize: "0.62rem", color, background: `${color}22`, borderRadius: "10px", padding: "0.1rem 0.45rem", fontWeight: 700, flexShrink: 0 }}>{memberName.split(" ")[0]}</span>
        )}
