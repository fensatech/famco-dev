...
export function GCalEventRow({ event, onClick }: { event: GCalEvent; onClick: () => void }) {
  ...
  return (
    <div
      data-cal-interactive="true"
      onClick={onClick}
      style={{ display: "flex", alignItems: "center", gap: "0.75rem", padding: "0.625rem 0.875rem", background: "rgba(99,102,241,0.08)", borderRadius: "10px", border: "1px solid rgba(99,102,241,0.22)", cursor: "pointer" }}
    >
      ...
      {event.member_name && <span style={{ fontSize: "0.65rem", color: "#6366f1", background: "rgba(99,102,241,0.12)", borderRadius: "999px", padding: "0.15rem 0.45rem", flexShrink: 0 }}>{event.member_name}</span>}
