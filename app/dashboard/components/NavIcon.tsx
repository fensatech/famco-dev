...
export function NavIcon({ id, size = 18, color = "currentColor" }: { id: string; size?: number; color?: string }) {
  ...
  if (id === "documents") return <svg style={s} viewBox="0 0 24 24" {...a}><path d="M14 2H7a2 2 0 00-2 2v16a2 2 0 002 2h10a2 2 0 002-2V7z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="15" y2="17"/></svg>
